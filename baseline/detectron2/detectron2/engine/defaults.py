...
def default_setup(cfg, args):
    ...
    # output_dir = '/opt/ml/detection/baseline/detectron2/output'
    ...
    seed = _try_get_key(cfg, "SEED", "train.seed", default=42)
...
class DefaultTrainer(TrainerBase):
    ...
    def build_writers(self):
        ...
        Returns:
            list[EventWriter]: a list of :class:`EventWriter` objects.
        """
        # self.cfg.OUTPUT_DIR = '/opt/ml/detection/baseline/detectron2/output'
